...
class Review:
    ...
    def __repr__(self):
        return f"<Review {self.id}: {self.year}, {self.summary}, emp_id={self.employee_id}>"
    ...
    def employee_id(self, value):
        # Check Employee exists and is persisted
        ...
        if isinstance(value, int):
            ...
            if emp:
                ...
                return
        raise Exception("employee_id must match a persisted Employee id")
