...
class Employee:
    ...
    # ----------------- CRUD -----------------
    def save(self):
        """Insert a new row with the current Employee object attributes"""
        sql = """
    ...
    def find_by_id(cls, id):
        """Return Employee object by primary key"""
    ...
    def find_by_name(cls, name):
        """Return first Employee object matching the given name"""
    ...
    # ----------------- RELATIONSHIPS -----------------
    def reviews(self):
        """Return list of Review instances associated with current employee"""
